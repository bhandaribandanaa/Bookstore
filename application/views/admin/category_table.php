...
?>
    <tr>
        ...
        <td><?php echo $r->cat_title;?></td>
            ...
            <td class="center">
            <a class="btn btn-info" href="editbookcategory/?id=<?php echo $r->cat_id;?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?');" href="deletebookcategory/?id=<?php echo $r->cat_id;?>">
