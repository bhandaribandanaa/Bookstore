...
?>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Showing the list of Slider</h2>
...
?>
    <tr>
        <td><?php echo $i; ?></td>
        <td><?php echo $r->slider_text;?></td>
        <td><?php $k= $r->image; ?><img src="<?php echo base_url().'/uploads/slider/'.$k ?>" height="200" width="250"></td>
    
            <td class="center">
            <a class="btn btn-info" href="editslider/?id=<?php echo $r->id;?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?');" href="deleteslider/?id=<?php echo $r->id;?>">
