...
?>
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="http://localhost/interface-bookstore/admin/category_controller">AddCategory</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
                <form role="form" action="<?=site_url('admin/category_controller/addbookcategory')?>" method="POST">
