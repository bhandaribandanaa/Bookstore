...
?>
    ...
    <div class="alert alert-info">Showing the List of Team Member<a href="" target="_blank"></a></div>
...
?>
    <tr>
        ...
        <td><?php $k= $r->image; ?><img src="<?php echo base_url().'/uploads/ourteam/'.$k ?>" height="100" width="100"></td>
        <td><?php echo $r->email;?></td>
        <td><?php echo $r->facebook;?></td>
    
            <td class="center">
            <a class="btn btn-info" href="editourteam/?id=<?php echo $r->id;?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?');" href="deleteourteam/?id=<?php echo $r->id;?>">
