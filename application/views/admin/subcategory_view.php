...
?>
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="http://localhost/interface-bookstore/admin/subcategory_controller/">AddCategory</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
                <form role="form" action="<?=site_url('admin/subcategory_controller/addbookcategory')?>" method="POST">
                    <div class="form-group">
                        <label>SubCategory Title</label>
                        <input type="text" class="form-control" name="subcat_title" id="subcat_title" required>
                    </div>
                    <div class="form-group">
