    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
                <form role="form" action="<?=site_url('admin/slider_controller/addslider')?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <button type="submit" name="add" value="upload" class="btn btn-primary">ADD TO SLIDER</button>&nbsp;
