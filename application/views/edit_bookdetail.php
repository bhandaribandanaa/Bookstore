    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
                <form role="form" action="<?=site_url('admin/book_detail/updatedetail')?>" method="POST">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="cat_id" id="cat_id" value="<?php echo $records->cat_id;?>" required>
                    </div>
                     <div class="form-group">
